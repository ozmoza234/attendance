...
<body>
    <div class="w-screen h-screen flex flex-col justify-center items-center lg:grid lg:grid-cols-2">
        ...
        <form class="flex flex-col justify-center items-center w-1/2" style=" margin: auto;" method="post" action="<?= base_url() ?>Auth/dashboard">
            <img title="Company Logo" width="100px" src="<?php echo base_url() ?>assets/img/login_page/man-crop.gif" />
            ...
            <div class="relative" style="margin-top: 4px;">
                <a href="<?php echo base_url() ?>auth">
                    <button type="button" class="mt-4 px-10 py-1 bg-blue-600 rounded-full font-bold text-white transform hover:translate-y-1 transition-all duration-500">Login</button>
                </a>
